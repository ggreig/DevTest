...
namespace DeveloperTest.Migrations
{
    ...
    [Migration("20210713214139_RelateJobsToCustomers")]
    partial class RelateJobsToCustomers
    {
            ...
            modelBuilder.Entity("DeveloperTest.Database.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            Engineer = "Test",
                            When = new DateTime(2021, 7, 13, 22, 41, 39, 497, DateTimeKind.Local).AddTicks(6685)
                        });
                });
